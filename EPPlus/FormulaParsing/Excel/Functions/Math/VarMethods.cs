...
{
	private static double Divide(double left, double right) => System.Math.Abs(right - 0d) < double.Epsilon ? throw new ExcelErrorValueException(eErrorType.Div0) : left / right;
