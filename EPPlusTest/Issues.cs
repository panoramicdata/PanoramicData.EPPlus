...
public class Issues : TestBase
{
	...
	{
		System.IO.FileInfo newFile = new(@"C:\Temp\output.xlsx");
	...
	{
		System.IO.FileInfo newFile = new(@"C:\Temp\bug\TableFormula.xlsx");
		ExcelPackage excelP = new(newFile);
		var ws = excelP.Workbook.Worksheets[1];
		ws.Calculate();
	}
	...
	{
		System.IO.FileInfo case1 = new(@"c:\temp\bug\src\src\DeleteRowIssue\Template.xlsx");
	...
	{
		System.IO.FileInfo newFile = new(@"C:\Temp\bug\test01.xlsx");
		ExcelPackage excelP = new(newFile);
		var ws = excelP.Workbook.Worksheets[1];
	...
	{
		using ExcelPackage p = new(new System.IO.FileInfo(@"C:\Temp\bug\ColumnInsert.xlsx"));
	...
	{
		FileInfo newFile = new(string.Format("c:\\temp\\bug\\EPPlus_Issue14699.xlsx", System.IO.Directory.GetCurrentDirectory()));
		OfficeOpenXml.ExcelPackage pkg = new(newFile);
