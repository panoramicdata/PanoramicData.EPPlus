...
public class WorkSheetTest : TestBase
{
	...
	public void LoadFromCollectionTest()
	{
		...
		ws.Cells["A45"].LoadFromCollection(list, true, OfficeOpenXml.Table.TableStyles.Light1, BindingFlags.Instance | BindingFlags.Instance, [typeof(TestDTO).GetMethod("GetNameID"), typeof(TestDTO).GetField("NameVar")]);
	...
	public void LoadFromEmptyCollectionTest()
	{
		...
		ws.Cells["A10"].LoadFromCollection(listDTO, true, OfficeOpenXml.Table.TableStyles.Light1, BindingFlags.Instance | BindingFlags.Instance, [typeof(TestDTO).GetMethod("GetNameID"), typeof(TestDTO).GetField("NameVar")]);
