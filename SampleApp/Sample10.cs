...
public static class Sample10
{
	public static void RunSample10()
	{
		...
		var templateFile = Utils.GetFileInfo(outputDir, "template.xlsx");
		var answerFile = Utils.GetFileInfo(outputDir, "answers.xlsx");
		var JKAnswerFile = Utils.GetFileInfo(outputDir, "JKAnswers.xlsx");
