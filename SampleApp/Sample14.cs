...
class Sample14
{
	...
	{
		var newFile = Utils.GetFileInfo("sample14.xlsx");
		using (ExcelPackage package = new(newFile))
		{
			...
			// -------------------------------------------------------------------
			ExcelAddress cfAddress1 = new("A2:A10");
			...
			// -------------------------------------------------------------------
			ExcelAddress cfAddress2 = new(2, 2, 10, 2);  //="B2:B10"
			...
			// -------------------------------------------------------------------
			ExcelAddress timePeriodAddress = new("D21:G34 C11:C20");
			...
			// -------------------------------------------------------------------
			ExcelAddress cellIsAddress = new("E11:E20");
			...
			ExcelAddress cfAddress43 = new("G2:G10");
			...
			ExcelAddress cfAddress44 = new("H2:H10");
