...
internal partial class ZipEntry
{
	...
	private void InternalExtract(string baseDir, Stream outstream, string password)
	{
		...
		try
		{
			...
			if (targetFileName != null)
			{
				...
				// (NTFS)
				if ((_VersionMadeBy & 0xFF00) is 0x00a0 or 0x0000)
	...
	private string UnsupportedAlgorithm
	{
		get
		{
			...
			alg = _UnsupportedAlgorithmId switch
			{
				0 => "--",
				0x6601 => "DES",
				...
				0x6801 => "RC4",
				// - Unknown algorithm
				_ => String.Format("Unknown (0x{0:X4})", _UnsupportedAlgorithmId),
			};
			return alg;
		}
	}
	...
	private string UnsupportedCompressionMethod
	{
		get
		{
			...
			meth = (int)_CompressionMethod switch
			{
				0 => "Store",
				1 => "Shrink",
				8 => "DEFLATE",
				...
				19 => "LZ77",
				98 => "PPMd",
				_ => String.Format("Unknown (0x{0:X4})", _CompressionMethod),
			};
			return meth;
		}
	}
