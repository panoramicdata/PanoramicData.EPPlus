...
internal partial class ZipFile
{
	...
	public void AddFiles(System.Collections.Generic.IEnumerable<String> fileNames) => AddFiles(fileNames, null);
	...
	/// </param>
	///
	public void UpdateFiles(System.Collections.Generic.IEnumerable<String> fileNames) => UpdateFiles(fileNames, null);
	...
	///   The <c>ZipEntry</c> corresponding to the Directory that was added or updated.
	/// </returns>
	public ZipEntry UpdateDirectory(string directoryName, String directoryPathInArchive) => AddOrUpdateDirectoryImpl(directoryName, directoryPathInArchive, AddOrUpdateAction.AddOrUpdate);
