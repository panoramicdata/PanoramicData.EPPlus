...
namespace OfficeOpenXml.Packaging.Ionic.Zip
{
	...
	partial class ZipFile
	{
		...
		public void AddSelectedFiles(String selectionCriteria) => AddSelectedFiles(selectionCriteria, ".", null, false);
		...
		/// </param>
		public void AddSelectedFiles(String selectionCriteria, bool recurseDirectories) => AddSelectedFiles(selectionCriteria, ".", null, recurseDirectories);
		...
		/// </param>
		public void AddSelectedFiles(String selectionCriteria, String directoryOnDisk) => AddSelectedFiles(selectionCriteria, directoryOnDisk, null, false);
		...
		///   If true, the file selection will recurse into subdirectories.
		/// </param>
		public void AddSelectedFiles(String selectionCriteria, String directoryOnDisk, bool recurseDirectories) => AddSelectedFiles(selectionCriteria, directoryOnDisk, null, recurseDirectories);
		...
		public void AddSelectedFiles(String selectionCriteria,
									 ...
									 String directoryPathInArchive) => AddSelectedFiles(selectionCriteria, directoryOnDisk, directoryPathInArchive, false);
											   ...
											   bool wantUpdate)
		{
			...
			Ionic.FileSelector ff = new(selectionCriteria,
...
namespace OfficeOpenXml.Packaging.Ionic
{
	...
	internal partial class FileSelector
	{
		...
		public ICollection<ZipEntry> SelectEntries(ZipFile zip, string directoryPathInArchive)
		{
			...
			var list = new List<ZipEntry>();
			// workitem 8559
			var slashSwapped = directoryPathInArchive?.Replace("/", "\\");
			// workitem 9174
