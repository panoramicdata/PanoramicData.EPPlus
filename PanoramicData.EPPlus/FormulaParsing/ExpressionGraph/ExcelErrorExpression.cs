...
public class ExcelErrorExpression : Expression
{
	...
	public override CompileResult Compile() => new(_error, DataType.ExcelError);//if (ParentIsLookupFunction)//{//    return new CompileResult(ExpressionString, DataType.ExcelError);//}//else//{//    return CompileRangeValues();//}
}
