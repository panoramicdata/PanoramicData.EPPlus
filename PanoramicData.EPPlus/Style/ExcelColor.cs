...
public sealed class ExcelColor : StyleBase, IColor
{
	...
	private ExcelColorXml GetSource()
	{
		...
		return _cls switch
		{
			eStyleClass.FillBackgroundColor => _styles.Fills[Index].BackgroundColor,
			eStyleClass.FillPatternColor => _styles.Fills[Index].PatternColor,
			eStyleClass.Font => _styles.Fonts[Index].Color,
			eStyleClass.BorderLeft => _styles.Borders[Index].Left.Color,
			eStyleClass.BorderTop => _styles.Borders[Index].Top.Color,
			eStyleClass.BorderRight => _styles.Borders[Index].Right.Color,
			eStyleClass.BorderBottom => _styles.Borders[Index].Bottom.Color,
			eStyleClass.BorderDiagonal => _styles.Borders[Index].Diagonal.Color,
