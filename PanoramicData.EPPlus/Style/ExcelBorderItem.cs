...
public sealed class ExcelBorderItem : StyleBase
{
	...
	private ExcelBorderItemXml GetSource()
	{
		...
		return _cls switch
		{
			eStyleClass.BorderTop => _styles.Borders[ix].Top,
			eStyleClass.BorderBottom => _styles.Borders[ix].Bottom,
			eStyleClass.BorderLeft => _styles.Borders[ix].Left,
			eStyleClass.BorderRight => _styles.Borders[ix].Right,
			eStyleClass.BorderDiagonal => _styles.Borders[ix].Diagonal,
