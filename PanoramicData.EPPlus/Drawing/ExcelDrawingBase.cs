...
public class ExcelDrawing : XmlHelper, IDisposable
{
		...
		base(drawings.NameSpaceManager, node)
	{
		...
		SchemaNodeOrder = ["from", "to", "graphicFrame", "sp", "clientData"];
	}
	/// <summary>
	...
	public eEditAs EditAs
	{
		...
		set
		{
			...
			SetXmlNodeString("@editAs", s[..1].ToLower(CultureInfo.InvariantCulture) + s[1..]);
		}
	}
	...
	internal static string GetTextAchoringText(eTextAnchoringType value) => value switch
	{
	...
	internal static eTextAnchoringType GetTextAchoringEnum(string text) => text switch
	{
	...
	internal static string GetTextVerticalText(eTextVerticalType value) => value switch
	{
	...
	internal static eTextVerticalType GetTextVerticalEnum(string text) => text switch
	{
