...
{
	private XmlDocument _drawingsXml = new();
	...
	internal Dictionary<string, string> _hashes = [];
	...
	private void AddDrawings()
	{
		...
		{
			var dr = node.LocalName switch
			{
				"oneCellAnchor" => ExcelDrawing.GetDrawing(this, node),
				"twoCellAnchor" => ExcelDrawing.GetDrawing(this, node),
				"absoluteAnchor" => ExcelDrawing.GetDrawing(this, node),
				//"absoluteCellAnchor":
				_ => null,
			};
			if (dr != null)
	...
	public ExcelChart AddChart(string Name, eChartType ChartType, ExcelPivotTable PivotTableSource)
	{
		...
		if (ChartType is eChartType.StockHLC or
			eChartType.StockOHLC or
			eChartType.StockVOHLC)
		{
	...
	public ExcelPicture AddPicture(string Name, Image image, Uri Hyperlink)
	{
		if (image != null)
		{
			...
			ExcelPicture pic = new(this, drawNode, image, Hyperlink)
			{
				Name = Name
			};
			_drawings.Add(pic);
	...
	public ExcelPicture AddPicture(string Name, FileInfo ImageFile, Uri Hyperlink)
	{
		...
		if (ImageFile != null)
		{
			...
			var drawNode = CreateDrawingXml();
			drawNode.SetAttribute("editAs", "oneCell");
			ExcelPicture pic = new(this, drawNode, ImageFile, Hyperlink)
			{
				Name = Name
			};
			_drawings.Add(pic);
	...
	public ExcelShape AddShape(string Name, eShapeStyle Style)
	{
		...
		ExcelShape shape = new(this, drawNode, Style)
		{
			Name = Name,
			Style = Style
		};
	...
	public ExcelShape AddShape(string Name, ExcelShape Source)
	{
		...
		ExcelShape shape = new(this, drawNode)
		{
			Name = Name,
			Style = Source.Style
		};
